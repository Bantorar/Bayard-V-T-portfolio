...
expensives <- read.csv(here::here("Data-raw", "Military Expenditure.csv"))
...
gdp_per_capita <- read.csv(here::here("Data-raw", "GDP_per_capita.csv"))
...
# Pivot and clean GDP
gdp <- read.csv(here::here("Data-raw", "GDP.csv"))
...
write_csv(combined_data_country, here::here("data-clean", "final-clean-data_country.csv"))

write_csv(combined_data_region_economically_income, here::here("data-clean", "final-clean-data_Economy.csv"))

write_csv(combined_data_region_geographically, here::here("data-clean", "final-clean-data_Geography.csv"))
```
